  ...
  return (
    <div className="flex flex-col gap-2 border border-gray-200 rounded-md p-4 bg-slate-50 shadow-md transition-transform transform-all hover:scale-105 duration-500">
      ...
      <TransactionButton 
        ...
        unstyled
        className="mt-4 w-full bg-blue-500 text-gray-100 font-medium px-4 py-2 rounded-md shadow-md  hover:bg-purple-800 hover:shadow-lg"
      >
        Select Tier
      </TransactionButton>
      {isEditing && (
        <TransactionButton 
          ...
          unstyled
          className="mt-4 w-full bg-red-500 text-gray-100 font-medium px-4 py-2 rounded-md shadow-md  hover:bg-purple-800 hover:shadow-lg"
        >
          Remove
        </TransactionButton>
      )}
